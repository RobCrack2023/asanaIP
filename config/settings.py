...
# ── CORS / CSRF ───────────────────────────────────────────────────────────────
_frontend = os.getenv('APP_URL', 'http://localhost:5173')
CORS_ALLOWED_ORIGINS = [_frontend, 'http://localhost:3000', 'http://localhost:5173']
CORS_ALLOW_CREDENTIALS = True
CSRF_TRUSTED_ORIGINS = [_frontend, 'http://localhost:3000', 'http://localhost:5173']

# ── Email ─────────────────────────────────────────────────────────────────────
EMAIL_BACKEND     = os.getenv('EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'AsanaIP <noreply@asanaip.com>')
